...
import { Plus, Phone, Layers, Trash2, MoreHorizontal } from 'lucide-react';
...
function ContactCard({
  ...
  return (
    <div className="relative rounded-xl border border-border/70 bg-background p-3 shadow-sm hover:border-primary/30 transition-colors">
...
function StageColumn({
  ...
  return (
    <div className="flex w-64 shrink-0 flex-col rounded-2xl border border-border/70 bg-muted/20">
      <div
